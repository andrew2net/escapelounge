...
game_step1 = GameStep.create(name: "Feeling a little blue...", description: "I come and I go, I sing high and low, when I'm around all stop to hear, and when I am gone everyone begins to fear. Being that I am blue, and round, what kind of animal am I to wear a crown?", value: "20", game_id: "2")
game_step2 = GameStep.create(name: "Things will get better, right?.", description: "When I am alone I cry, and when I am with the lions I roar high, yet when I am with you I want to fry banana cheesecake, and that worries my mother who much prefers banane beefcake.", value: "35", game_id: "2")
